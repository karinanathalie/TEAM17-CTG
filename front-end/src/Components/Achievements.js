...
import b1 from "../img/badge_1.png";
import b2 from "../img/badge_2.png";
  ...
  return (
    <Container className="flex w-[655px] h-[180px] font-poppins bg-lightblue rounded-[16px]">
      <Wrapper className="flex flex-col w-full font-[24px] mx-[31px] my-[19px] ">
        <Wrapper className="text-[12px] font-bold w-1/2">Streak 🔥</Wrapper>
        ...
        <Wrapper className="flex items-center gap-2 mt-3">
          <div className="flex space-x-2">
            {Array.from({ length: 5 }, (_, i) => (
              <span
                key={i}
                className="mt-[-5px] w-8 h-8 bg-pink rounded-full flex items-center justify-center text-white font-bold"
              >
          ...
          <Wrapper className="mt-2 flex flex-wrap justify-center gap-2">
            {Array.from({ length: 4 }, (_, i) => (
              <img
                key={i}
                src={b1}
                className="w-[50px] h-[50px] bg-blue rounded-full flex items-center justify-center text-white font-bold"
              ></img>
            ))}
            {Array.from({ length: 4 }, (_, i) => (
              <img
