...
const Volunteer: React.FC<EventProps> = ({ isSidebarOpen }) => {
    ...
    useEffect(() => {
        fetch('http://0.0.0.0:8000/api/profile/volunteers')
    ...
    <Box style={{ margin: 40, width: containerWidth }}>
            ...
            >
                <Breadcrumbs>
                    <Typography variant='h5' color='primary'>Volunteers</Typography>
                </Breadcrumbs>
